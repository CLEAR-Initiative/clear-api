...
const { signalLocationChallenges } = signalResolvers.Query;
const { submitSignalLocationChallenge } = signalResolvers.Mutation;
const { locationChallenge } = signalResolvers.Signal;
const { hasProposedPoint } = signalResolvers.SignalLocationChallenge;
